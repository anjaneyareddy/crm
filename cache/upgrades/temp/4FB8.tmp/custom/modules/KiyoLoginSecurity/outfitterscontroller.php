 ...
 * 
 ********************************************************************************/
require_once('modules/KiyoLoginSecurity/license/LoginSecurityOutfittersLicense.php');
...
if($_REQUEST['method'] == 'validate') {
    LoginSecurityOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    LoginSecurityOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    LoginSecurityOutfittersLicense::add();
    ...
    $validate_license = LoginSecurityOutfittersLicense::isValid($currentModule,$user_id,true);

    if($validate_license !== true) {

        echo "License did NOT validate.<br/><br/>Reason: ".$validate_license;
        
        $validated = LoginSecurityOutfittersLicense::doValidate($currentModule);
