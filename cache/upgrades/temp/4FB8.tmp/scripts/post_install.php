...
function post_install() {
    ...
    if(preg_match( "/^6.*/", $sugar_version)) {
        echo "
            <script>
            document.location = 'index.php?module=KiyoLoginSecurity&action=license';
            </script>"
        ;
    } else {
        echo "
            ...
            window.parent.SUGAR.App.sync({callback: function(){
                app.router.navigate('#bwc/index.php?module=KiyoLoginSecurity&action=license', {trigger:true});
            }});
            </script>"
        ;
    }
