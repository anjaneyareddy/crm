...
',
  ...
  'LBL_OUTPUT' => 'OUTPUT',
  'LBL_RESULT' => 'Result',
  'LBL_SUDOLOGINADDON' => 'Sudo Login Add-on',
  'LBL_LOGIN_SECURITY' => 'Login Security',
  'LBL_LOGIN_SECURITY_DESCRIPTION' => 'Configure Login Security Details to restrict User for accessing CRM from specific Location using IP Address',
  'LBL_NO_RECORDS_FOUND' => 'No Records Found',
  'LBL_BULK_ACTION' => 'BULK ACTION',
  'LBL_ACTIVE' => 'Active',
  'LBL_INACTIVE' => 'Inactive',
  'LBL_DELETE' => 'Delete',
  'LBL_BLOCKING_TYPE' => 'Blocking Type',
  'LBL_USERS_IP_BLOCKING' => 'Users for Ip Blocking',
  'LBL_DATE_CREATED' => 'Date Entered',
  ...
  'LBL_NEXT' => 'Next',
  'LBL_SAVE' => 'Save',
  'LBL_CREATE_MESSAGE' => 'You currently have no records saved.',
  'LBL_CREATE' => 'CREATE',
  'LBL_CREATE_MESSAGE_ONE' => 'one now.',
  'LBL_LOGIN_SECURITY_STATUS_ACTIVATED' => 'Status Activated Successfully!!!',
  'LBL_LOGIN_SECURITY_STATUS_DEACTIVATED' => 'Status Deactivated Successfully!!!',
  'LBL_DELETE_MSG' => 'Are You Sure You Want to Delete',
  'LBL_THESE' => 'these',
  'LBL_THIS' => 'this',
  'LBL_ROW' => 'row?',
  'LBL_SELECT_AN_OPTION' => 'Select an Option',
  'LBL_IP_BLOCKING' => 'IP Blocking',
  'LBL_OTP_BASED' => 'OTP Based',
  'LBL_SELECT_IP_BLOCKING_TYPE' => 'Select Ip Blocking Type',
  'LBL_SELECT_USERS_IP_BLOCKING' => 'Select Users Type for Ip Blocking',
  'LBL_SELECT_USERS' => 'Select Users',
  'LBL_ALLOW_SELECTED_USERS_FROM_SPECIFIC_IP' => 'Allow Selected Users from Specific Ip',
  'LBL_USER' => 'Users',
  'LBL_GROUP' => 'Groups',
  'LBL_SPECIFIC_IP' => 'Specific IP',
  'LBL_ALL_RANGE' => 'All Range',
  'LBL_COMMA_SEPARATED' => 'Comma Separated',
  'LBL_ALL_USERS' => 'All Users',
  'LBL_SPECIFIC_GROUP_USER' => 'Specific Group or User',
  'LBL_ALLOW_ALL_USERS_SPECIFIC_IP' => 'Allow All Users from Specific IP',
  'LBL_DENY_ALL_USERS_SPECIFIC_IP' => 'Deny All Users from Specific IP',
  'LBL_ALLOW_SELECTED_USERS_SPECIFIC_IP' => 'Allow Selected Users from Specific IP',
  'LBL_DENY_SELECTED_USERS_SPECIFIC_IP' => 'Deny Selected Users from Specific IP',
  'LBL_ALLOW_ALL_USERS_SEPCIFIC_RANGE_IP' => 'Allow All Users from Specific Range Ips',
  'LBL_DENY_ALL_USERS_SEPCIFIC_RANGE_IP' => 'Deny All Users from Specific Range Ips',
  'LBL_ALLOW_SELECTED_USERS_SEPCIFIC_RANGE_IP' => 'Allow Selected Users from Specific Range Ips',
  'LBL_DENY_SELECTED_USERS_SEPCIFIC_RANGE_IP' => 'Deny Selected Users from Specific Range Ips',
  'LBL_FIRST_SELECT_IP_BLOCK_TYPE' => 'Please first Select IP Blocking Type.',
  'LBL_ADD_IP_ADDRESSES_ALLOW_SELECTED_USERS' => 'Add Ip Addresses for Allow Selected Users',
  'LBL_ADD_IP_ADDRESSES_DENY_SELECTED_USERS' => 'Add Ip Addresses for Deny Selected Users',
  'LBL_ADD_IP_ADDRESSES_ALLOW_ALL_USERS' => 'Add Ip Addresses for Allow All Users',
  'LBL_ADD_IP_ADDRESSES_DENY_ALL_USERS' => 'Add Ip Addresses for Deny All Users',
  'LBL_ADD_MODULE_SELECTION' => 'Ip Blocking Step has been added Successfully!!!',
  'LBL_UPDATE_MODULE_SELECTION' => 'Ip Blocking Step has been updated Successfully!!!',
  'LBL_INFO_INLINE' => 'Info Inline',
  'LBL_SELECT_IP_BLOCKING_TYPE_INFO' => 'Select IP Blocking Type either Specific IP or All Range or Comma Separated.',
  'LBL_SELECT_USERS_IP_BLOCKING_INFO' => 'Select User Type for IP Blocking either All Users or Sepecific Group/User.',
  'LBL_SELECT_USERS_INFO' => 'Select Users or Groups for which you want to apply IP Blocking.',
  'LBL_STATUS_INFO' => 'Active/Inactive',
  'LBL_DIFFERENT_IP_DENY_USERS_IP' => 'Please add different ip from \'Deny All Users from Specific IP\'.',
  'LBL_DIFFERENT_IP_ALLOW_RANGE_USERS_IP' => 'Please add different ip from \'Allow All Users to Specific Range Ips\'.',
  'LBL_ADD_LESS_IP' => 'Please add less IP for \'Allow All Users From Specific Ip\' from \'Allow All Users To Specific Ip\'',
  'LBL_ADD_GREATER_RANGE_IP_DENY_USERS' => 'Please add Greater IP for \'Deny All Users From Specific Range Ips\' from \'Allow All Users To Specific Range Ips\'',
  'LBL_ADD_GREATER_IP_ALLOW_SEL_USERS' => 'Please add Greater IP for \'Allow Selected Users To Specific Ip\' from \'Allow Selected Users From Specific Ip\'',
  'LBL_DIFFERENT_IP_DENY_TO_RANGE_USERS_IP' => 'Please add different ip from \'Deny All Users from Specific Range Ips\'.',
  'LBL_DIFFERENT_IP_ALLOW_USERS_IP' => 'Please add different ip from \'Allow All Users from Specific IP\'.',
  'LBL_DIFFERENT_IP_ALLOW_SELECTED_USERS_IP' => 'Please add different ip from \'Allow Selected Users from Specific IP\'.',
  'LBL_DIFFERENT_IP_DENY_SELECTED_USERS_IP' => 'Please add different ip from \'Deny Selected Users from Specific IP\'.',
  'LBL_DO_NOT_USE_DENY_SEL_USERS' => 'Please do not use this id. Because its already selected in \'Deny Selected Users from Specific Range Ips\'',
  'LBL_DO_NOT_USE_DENY_ALL_USERS' => 'Please do not use this id. Because its already selected in \'Deny All Users from Specific Range Ips\'',
  'LBL_DO_NOT_USE_ALLOW_SEL_USERS' => 'Please do not use this id. Because its already selected in \'Allow Selected Users from Specific Range Ips\'',
  'LBL_DO_NOT_USE_ALLOW_ALL_USERS' => 'Please do not use this id. Because its already selected in \'Allow All Users from Specific Range Ips\'',
  'LBL_ADD_LESS_IP_ALLOW_SEL_USERS' => 'Please add less IP for \'Allow Selected Users From Specific Ip\' from \'Allow Selected Users To Specific Ip\'',
  'LBL_ADD_LESS_IP_DENY_SEL_USERS' => 'Please add less IP for \'Deny Selected Users From Specific Ip\' from \'Deny Selected Users To Specific Ip\'',
  'LBL_ADD_LESS_IP_DENY_ALL_USERS' => 'Please add less IP for \'Deny All Users From Specific Ip\' from \'Deny All Users To Specific Ip\'',
  'LBL_ADD_GREATER_IP_TO_DENY_SEL_USERS' => 'Please add Greater IP for \'Deny Selected Users To Specific Ip\' from \'Deny Selected Users From Specific Range Ip\'',
  'LBL_ADD_GREATER_IP_TO_DENY_ALL_USERS' => 'Please add Greater IP for \'Deny All Users To Specific Ip\' from \'Deny All Users From Specific Range Ip\'',
  'LBL_DO_NOT_ADD_SAME_ALLOW_IP' => 'Please Do not add same ip address for \'Add Ip Addresses for Allow All Users\'.',
  'LBL_ADD_DIFF_IP_ADDRESS_DENY_ALL_USERS' => 'Please add different Ip Address from \'Add Ip Addresses for Deny All Users\'.',
  'LBL_DO_NOT_ADD_SAME_DENY_IP' => 'Please Do not add same ip address for \'Add Ip Addresses for Deny All Users\'.',
  'LBL_ADD_DIFF_IP_ADDRESS_ALLOW_ALL_USERS' => 'Please add different Ip Address from \'Add Ip Addresses for Allow All Users\'.',
  'LBL_DO_NOT_ADD_SAME_ALLOW_SELECTED_IP' => 'Please Do not add same ip address for \'Add Ip Addresses for Allow Selected Users\'.',
  'LBL_ADD_DIFF_IP_ADDRESS_DENY_SELECTED_USERS' => 'Please add different Ip Address from \'Add Ip Addresses for Deny Selected Users\'.',
  'LBL_DO_NOT_ADD_SAME_DENY_SELECTED_IP' => 'Please Do not add same ip address for \'Add Ip Addresses for Deny Selected Users\'.',
  'LBL_ADD_DIFF_IP_ADDRESS_ALLOW_SELECTED_USERS' => 'Please add different Ip Address from \'Add Ip Addresses for Allow Selected Users\'.',
  'LBL_ADD_VALID_IP' => 'Please add valid ip address.',
  'LBL_SMS_TRIGGER_MSG' => 'Select the SMS Trigger Type.',
  'LBL_RESEND_OTP_MSG' => 'Select the Resend OTP Type.',
  'LBL_OTP_LOGIN_SECURITY' => 'Enable OTP Based Login Security',
  'LBL_OTP_TYPE' => 'OTP Type',
  'LBL_EMAIL' => 'Email',
  'LBL_SUBJECT' => 'Subject',
  'LBL_ADDED_RECORD' => 'Login Security Record Added Successfully!!!',
  'LBL_UPDATED_RECORD' => 'Login Security Record Updated Successfully!!!',
  'LBL_NOT_RECORD' => 'Login Security Record not Successfully!!!',
  'LBL_REQUIRE_FIELD' => 'Please Select All Require Fields!!!',
  'LBL_EMAIL_BODY' => 'Email Body',
  'LBL_OTP_TYPE_INFO' => 'Select the OTP Type.',
  'LBL_SMS_TRIGGER' => 'SMS Trigger',
  'LBL_WEEK' => 'Week',
  'LBL_MONTH' => 'Month',
  'LBL_DAYS_RESEND_OTP' => 'Days to Resend OTP',
  'LBL_30_DAYS' => '30 Days',
  'LBL_60_DAYS' => '60 Days',
  'LBL_180_DAYS' => '180 Days',
  'LBL_RESEND_OTP_IN_MINUTES' => 'Resend OTP in Minutes',
