...
class ViewLicense extends SugarView
{
    ...
    public function display()
    {
        ...
        require_once('modules/'.$currentModule.'/license/LoginSecurityOutfittersLicense.php');
        ...
        $key = LoginSecurityOutfittersLicense::getKey($currentModule);
        if(!empty($key)) {
        ...
        $this->ss->display('modules/KiyoLoginSecurity/tpls/license.tpl');
    }//end of display
