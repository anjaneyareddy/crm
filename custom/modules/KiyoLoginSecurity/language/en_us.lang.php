...
$license_strings = array (
    ...
    'LBL_STEPS_TO_LOCATE_KEY' => '1. Login to <a href="https://store.suitecrm.com" target="_blank">KiyoCRM Store</a><br/>2. Go to Account->Purchases</br>3. Locate the key for the purchase of this add-on<br/>4. Paste into the License Key box below<br/>5. Hit "Validate"',
    ...
    'LBL_HOWTO_REDUCE_LICENSE' => 'Need to decrease your total licenses? Simply log into the KiyoCRM Store and change the number of users for this add-on under your Purchases.',
