...
class ViewLicense extends SugarView
{
    ...
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
           ...
           translate('LBL_SUDOLOGINADDON','Administration').': '.translate('LBL_SUDOLOGINADDON_LICENSE_TITLE','Administration'),
           );
    }
    ...
    public function display()
    {
        ...
        $key = SudoLoginOutfittersLicense::getKey($currentModule);
