...
if(!class_exists('SudoLoginOutfittersLicense')) 
{
    class SudoLoginOutfittersLicense
    {
        /**
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false)
        {
            ...
            $validated = SudoLoginOutfittersLicense::doValidate($thisModule);
        ...
        public static function validate()
        {
            ...
            $validated = SudoLoginOutfittersLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null)
        {
            ...
            {
                $GLOBALS['log']->fatal('SudoLoginOutfittersLicense::doValidate() failed: '.print_r($response,true));
            }
        ...
        public static function change()
        {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('SudoLoginOutfittersLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add()
        {
            ...
            $response = SudoLoginOutfittersLicense::doValidate($currentModule);
    ...
    class SugarOutfitters_API
    {
        private function get_default_payload($module,$custom_data = array())
        {
            ...
            if (empty($custom_data['key'])){
                $key = SudoLoginOutfittersLicense::getKey($module);
