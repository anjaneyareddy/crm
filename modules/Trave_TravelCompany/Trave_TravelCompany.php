...
class Trave_TravelCompany extends Company
{
    public $new_schema = true;
    public $module_dir = 'Trave_TravelCompany';
    public $object_name = 'Trave_TravelCompany';
    public $table_name = 'trave_travelcompany';
    ...
    public $trave_travelcompany_type;
    public $industry;
